...
userRoute.get("/", authentication_1["default"], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, userService.fetchAllUsers()];
            case 2:
                users = _a.sent();
                (0, responseService_1.sendResponse)(res, 200, "Successfully retrieved the list of users.", users);
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                console.error("Error fetching users:", error_1);
                (0, responseService_1.sendResponse)(res, 500, "An error occurred while fetching users.");
                return [3 /*break*/, 4];
...
userRoute.get("/:id", authentication_1["default"], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userService.fetchUserInformation(userId)];
            case 1:
                user = _a.sent();
                (0, responseService_1.sendResponse)(res, 200, "Successfully retrieved user information.", user);
                return [3 /*break*/, 3];
            case 2:
                (0, responseService_1.sendResponse)(res, 400, "Invalid userId: user id must be a number");
                _a.label = 3;
            case 3: return [3 /*break*/, 5];
            case 4:
                error_2 = _a.sent();
                console.error("Error fetching user:", error_2);
                (0, responseService_1.sendResponse)(res, 500, "Failed to retrieve user: ".concat(error_2 instanceof Error ? error_2.message : 'Unknown error'));
                return [3 /*break*/, 5];
...
// Register User
userRoute.post("/registerUser", authentication_1["default"], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                console.log(newUser);
                if (!(newUser.user_name && newUser.first_name && newUser.last_name && newUser.password)) return [3 /*break*/, 2];
                return [4 /*yield*/, userService.registerUser(newUser)];
            case 1:
                signUpUser = _a.sent();
...
// Updater User
userRoute.put("/:id", authentication_1["default"], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, updatedData, result, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, userService.updateUser(userId, updatedData)];
            case 1:
                result = _a.sent();
...
// Delete User
userRoute["delete"]("/:id", authentication_1["default"], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, message, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
